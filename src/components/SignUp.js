                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="form__inputs">
                                ...
                                <div className="form__input">
                                    ...
                                    <input className="" type="password" ref={passwordRef} placeholder="Lösenord" required/>
                                </div>

                                <div className="form__input">
                                    <FontAwesomeIcon icon={faLock} className="form__icon"/>
                                    <input className="" type="password" ref={passwordConfirmRef} placeholder="Bekräfta lösenord" required/>
                                </div>                                
                            </div>
                            <div className="form__button">
                                <button disabled={loading} className="form__button">Skapa konto</button>
                            </div>
                        </form>
